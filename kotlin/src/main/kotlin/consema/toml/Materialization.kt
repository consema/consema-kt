...
//   - https://github.com/consema/consema-rs/blob/main/consema-toml/src/materialization.rs (materialize,
//     materialize_complete and requested_contract, PreparedRoot and the
//     explicit UniqueStringEntriesToObject conversion with the
//     core.materialization.mapping-transformed@1 event, the derived parse
//     limits, TomlWriter, BoundedOutput, ProvenanceBuilder,
//     scalar_kind_matches).
