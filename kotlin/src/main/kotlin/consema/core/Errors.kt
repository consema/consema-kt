...
// Rust StableFailure mapping (https://github.com/consema/consema-rs/blob/main/consema-pvce/src/lib.rs:1062-1087);
...
// error-code registry (https://github.com/consema/consema-rs/blob/main/consema-protocol/src/error_registry.rs
...
enum class PvceErrorKind(val code: String) {
     ...
     * https://github.com/consema/consema-rs/blob/main/consema-pvce/src/lib.rs:971-979). */
...
class DuplicateKeyException(val key: String) :
     ...
     * (https://github.com/consema/consema-rs/blob/main/consema-pvce/src/lib.rs:1082). */
