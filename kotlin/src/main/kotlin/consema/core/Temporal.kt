...
// OffsetDateTime.
//
// Data authority: RFC 0016 §4.1 (docs/rfcs/0016-go-api-mapping-v1.md:140-143)
// plus the Rust constructors (crates/consema-core/src/value.rs:419-576):
...
/** The frozen invalid-temporal code (crates/consema-pvce/src/lib.rs:1082). */
 ...
 * Rust Decimal::is_fraction, crates/consema-core/src/value.rs:337-352): a
