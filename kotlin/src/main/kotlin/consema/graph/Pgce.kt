...
//
// Byte layout authority: crates/consema-graph/src/pgce.rs (the frozen Rust
...
/** The PGCE/1 stream magic (ASCII "PGCE", crates/consema-graph/src/pgce.rs:12). */
internal val PGCE_MAGIC = byteArrayOf('P'.code.toByte(), 'G'.code.toByte(), 'C'.code.toByte(), 'E'.code.toByte())

/** The frozen PGCE/1 version (crates/consema-graph/src/pgce.rs:14). */
internal const val PGCE_VERSION: ULong = 1uL

// Node record octets (crates/consema-graph/src/pgce.rs:16-18).
 ...
 * PgceLimits, crates/consema-graph/src/pgce.rs:21-54). The zero value
...
data class PgceLimits(
    ...
    companion object {
         ...
         * 64 MiB scalar, depth 256; crates/consema-graph/src/pgce.rs:
         * 41-54). */
     ...
     * PgceLimits::graph_limits, crates/consema-graph/src/pgce.rs:56-68). */
 ...
 * (the Rust encode_pgce_bounded, crates/consema-graph/src/pgce.rs:
 ...
 * work (the Rust validate_graph_limits, crates/consema-graph/src/pgce.rs:
 * 277-284). */
 ...
 * crates/consema-graph/src/pgce.rs:286-339). */
 ...
 * blob_size, crates/consema-graph/src/pgce.rs:348-350). */
 ...
 * (the Rust check_encode_limit, crates/consema-graph/src/pgce.rs:360-374). */
 ...
 * crates/consema-graph/src/pgce.rs:392-396). */
 ...
 * write_varint, crates/consema-graph/src/pgce.rs:398-410). */
 ...
 * Rust const varint_size, crates/consema-graph/src/pgce.rs:412-419). */
 ...
 * body of the Rust decode_pgce, crates/consema-graph/src/pgce.rs:437-505).
 ...
 * crates/consema-graph/src/pgce.rs:509-595). */
internal class Decoder(private val bytes: ByteArray, private val limits: PgceLimits) {
     ...
     * 64-bit overflow (the Rust Decoder::varint, crates/consema-graph/
     * src/pgce.rs:539-557). */
    fun varint(): ULong {
        val start = offset
        var value = 0uL
 ...
 * map_build_to_decode, crates/consema-graph/src/pgce.rs:613-627): resource
 ...
 * map_encode_to_decode, crates/consema-graph/src/pgce.rs:629-642):
