...
/** The PGCE/1 stream magic (ASCII "PGCE", https://github.com/consema/consema-rs/blob/main/consema-graph/src/pgce.rs). */
internal val PGCE_MAGIC = byteArrayOf('P'.code.toByte(), 'G'.code.toByte(), 'C'.code.toByte(), 'E'.code.toByte())

/** The frozen PGCE/1 version (https://github.com/consema/consema-rs/blob/main/consema-graph/src/pgce.rs). */
internal const val PGCE_VERSION: ULong = 1uL

// Node record octets (https://github.com/consema/consema-rs/blob/main/consema-graph/src/pgce.rs).
 ...
 * PgceLimits, https://github.com/consema/consema-rs/blob/main/consema-graph/src/pgce.rs). The zero value
...
data class PgceLimits(
     ...
     * PgceLimits::graph_limits, https://github.com/consema/consema-rs/blob/main/consema-graph/src/pgce.rs). */
 ...
 *). It never truncates: exceeding any limit throws a resource-limit
 ...
 * https://github.com/consema/consema-rs/blob/main/consema-graph/src/pgce.rs). */
 ...
 * blob_size, https://github.com/consema/consema-rs/blob/main/consema-graph/src/pgce.rs). */
 ...
 * (the Rust check_encode_limit, https://github.com/consema/consema-rs/blob/main/consema-graph/src/pgce.rs). */
 ...
 * write_varint, https://github.com/consema/consema-rs/blob/main/consema-graph/src/pgce.rs). */
 ...
 * Rust const varint_size, https://github.com/consema/consema-rs/blob/main/consema-graph/src/pgce.rs). */
 ...
 * body of the Rust decode_pgce, https://github.com/consema/consema-rs/blob/main/consema-graph/src/pgce.rs).
...
internal class Decoder(private val bytes: ByteArray, private val limits: PgceLimits) {
     ...
     * pgce.rs). UTF-8 validity is enforced here so that malformed
 ...
 * map_build_to_decode, https://github.com/consema/consema-rs/blob/main/consema-graph/src/pgce.rs): resource
 ...
 * map_encode_to_decode, https://github.com/consema/consema-rs/blob/main/consema-graph/src/pgce.rs):
