...
//   - RFC 0003 §3-§5 (docs/rfcs/0003-source-syntax-query-and-patch-v1.md):
...
//   - crates/consema-document/src/source.rs:476-666 (SourceSnapshot),
//     source.rs:669-725 (SourceError, UnsupportedBomKind), and the decode
//     rules source.rs:727-1220; crates/consema-conformance/src/source_v1.rs:
//     410-421 maps SourceError variants to the registered codes.
//   - go/document/source.go is a cross-reference only.
//
// The registered error codes (crates/consema-protocol/src/error_registry.rs:
