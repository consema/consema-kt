...
class LimitsTest {
    ...
    /** lib.rs: 64 MiB source bytes, depth 256, 2,000,000 tokens,
    ...
    /** materialization.rs: 1,000,000 input nodes, 64 MiB output
    ...
    /** source.rs: 64 MiB raw bytes, 128 MiB decoded UTF-8 bytes,
    ...
    fun sourceLimitsDefaultsAreFrozen() {
        ...
        // The compatibility limits (source.rs).
    ...
    /** source_patch.rs: default source limits, 100,000 replacements,
     * 128 MiB patch bytes. */
    @Test
