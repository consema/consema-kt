...
//   - crates/consema-xml/src/projection.rs is the byte-arbitration
...
//   - RFC 0004 §7-§8 (docs/rfcs/0004-...md:171-218) pins the completion
...
private class ProjectionContext(
    ...
    fun report(): ProjectionReport = ProjectionReport(reportEvents.toList())

    fun provenance(): ProvenanceMap = ProvenanceMap(provenanceEntries.toList())
